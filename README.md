...
2. Le fichier `config.json` doit être modifié pour contenir les informations liées à votre cours.
3. Voir [Installation](#installation) et [Développement Local](#développement-local) pour voir comment démarrer le serveur
4. Modifiez les documents Markdown qui sont dans la répertoire `docs` selon vos besoins.
5. Profit
